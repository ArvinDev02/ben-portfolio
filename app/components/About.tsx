    ...
    <section className='about-section' id="about">
        <div className='container'>
            ...
            >
                ...
                <p>
                    Hey there! I'm Arvin Garcellano, a Philippines-based front-end website developer and graphic designer. I specialize in crafting visually stunning websites with seamless user experiences. Let's work together to bring your digital ideas to life!
                </p>
                <p>
